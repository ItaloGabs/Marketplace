...
// const Those3DTexts = require('that-3d-text-library');
// const gsap = require('gsap').gsap;
// const MotionPathPlugin = require('gsap/MotionPathPlugin').MotionPathPlugin;
...
const LETTER = document.querySelector('#text-3d-loading')
const BODY = document.body;

let count = 0;

// BODY.classList.add('style-14');
LETTER.classList.add('font-0');

const setNextStyle = () => {

//   BODY.classList.remove(`style-14`);
